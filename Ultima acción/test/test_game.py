...
import json
import datetime
from app import app, ensure_user_plots
...
class CodeAndCropTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///:memory:' # Base de datos aislada en memoria RAM
    ...
    def tearDown(self):
        """Limpieza absoluta de la base de datos después de cada test."""
        with app.app_context():
            db.session.remove()
            db.drop_all()
    ...
    def test_ensure_64_plots_and_level_bounds(self):
        ...
        with app.app_context():
            # Comprobar que en base de datos existan las 64 parcelas del mapa potencial de Anurash
    ...
    # =========================================================================
    # TEST DE LÓGICA DE NEGOCIO: PROGRESIÓN SECUENCIAL DE CUESTIONARIOS
    # =========================================================================
